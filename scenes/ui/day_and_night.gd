...
#
## Enum TimeOfDay (để tự tính trong panel này)
#enum TimeOfDay {
	#MORNING,     # 07:00 - 09:59
	#NOON,        # 10:00 - 12:59
...
#func _update_from_current_time() -> void:
	...
	## Cập nhật ngày
	#if day_label:
		##day_label.text = str(mgr.current_day)
		#day_label.text = "DAY " + str(mgr.current_day)   # nếu muốn có chữ DAY
	#
...
#
#
## Hàm tính giờ từ time (vì manager hiện tại chưa có get_current_hour)
