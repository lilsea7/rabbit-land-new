...
func _ready() -> void:
	add_to_group("large_tree")  # ← Thêm vào group
...
func on_hurt(hit_damage: int) -> void:
	...
	SoundManager.play_hurt_sfx(global_position)
...
func on_max_damage_reached() -> void:
	...
	if save_component and save_component.has_method("mark_tree_as_removed"):
		save_component.mark_tree_as_removed(global_position, "large")
		print("📌 Đã đánh dấu large tree bị chặt tại: ", global_position)
